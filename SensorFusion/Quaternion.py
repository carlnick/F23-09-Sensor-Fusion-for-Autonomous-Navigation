...
class Quaternion:
    ...
    def __mul__(self, other):
        ...
        if isinstance(other, (float, int)):
            return Quaternion(
                self.q0 * other, self.q1 * other, self.q2 * other, self.q3 * other
            )
        ...
        raise TypeError(
            "Only Quaternion or Numeric literals for operand types are allowed."
        )

    def __str__(self):
        return f"[{self.q0:0.8f}, {self.q1:0.8f}, {self.q2:0.8f}, {self.q3:0.8f}]"
